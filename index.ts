...
import { addUser, getData, getUserById, setData } from "./helpers";
...
export let currentChallenge: string | undefined;
...
// const userData = getUserById(loggedInUserId);
...
app.get("/generate-registration-options", (req, res) => {
  ...
  console.log("inMemoryUserDeviceDB user ", user);
...
app.post("/verify-registration", async (req, res) => {
  ...
  try {
    const opts: VerifyRegistrationResponseOpts = {
      ...
      expectedOrigin: ["http://localhost:5173", "http://localhost:8000"],
      expectedRPID: rpID,
